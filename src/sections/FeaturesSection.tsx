...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create a stunning thumbnails that get clicks, without any hassle" />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our Ai understands what makes a video gp viral and designs thumbnails accodingly.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Stop guessing and start ranking. Our AI creates designs proven to capture attentiion.</p>
